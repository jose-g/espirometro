...
public class F300SearchRecyclerViewAdapter extends RecyclerView.Adapter<minsa.formulario.Adapters.recyclerview.F300SearchRecyclerViewAdapter.ViewHolder> {
    ...
    public F300SearchRecyclerViewAdapter(Context context, List<F300DataSet> lista) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.model_item_f300_search, viewGroup, false);
    ...
    public void setOnLongClickListener(ClickListener clickListener) {
        minsa.formulario.Adapters.recyclerview.F300SearchRecyclerViewAdapter.clickListener = clickListener;
    }
