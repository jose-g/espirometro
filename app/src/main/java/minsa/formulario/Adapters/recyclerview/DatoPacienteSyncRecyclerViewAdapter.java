...
public class DatoPacienteSyncRecyclerViewAdapter extends RecyclerView.Adapter<minsa.formulario.Adapters.recyclerview.DatoPacienteSyncRecyclerViewAdapter.ViewHolder> {
    ...
    public DatoPacienteSyncRecyclerViewAdapter(Context context, List<DatoPacienteDataSet> lista) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.model_item_dato_paciente_sync, viewGroup, false);
    ...
    public void setOnLongClickListener(ClickListener clickListener) {
        minsa.formulario.Adapters.recyclerview.DatoPacienteSyncRecyclerViewAdapter.clickListener = clickListener;
    }
